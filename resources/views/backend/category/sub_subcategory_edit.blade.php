...
<div class="row">
            ...
            @csrf
                ...
                <div class="form-group">
					...
					<div class="controls">
						<select name="subcategory_id" class="form-control" aria-invalid="false">
							...
							<option value="{{$subcategory->id}}">{{$subcategory->category_name_tr}}</option>
							@endforeach
						</select>
				...
				<div class="form-group">
                    <h5>SubSubCategory Turkish <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="subsubcategory_name_tr" class="form-control" value="{{$subsubcategories->subsubcategory_name_tr}}">
